...
// Action constants
val actionOptions: Array<String> = arrayOf("Feed", "Give water", "Pet", "Go for a walk", "Go to work")
val actionPrices: Array<String> = arrayOf("-10 Coins", "-5 Coins", "Free", "Free", "+100 Coins")
